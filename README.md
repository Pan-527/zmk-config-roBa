...
- SCROLL レイヤーの 2 か所が素の Cmd になっているので、Cmd+ホイール (Figma やブラウザのズーム) ができます。K + J + ボールなら右手だけ (薬指 K + 中指 J + 親指ボール)、K + 左親指 Cmd + ボールなら両手を使います。
...
| ズーム | K + J を押しながらボール (右手だけ)、または K + 左親指 Cmd + ボール |
